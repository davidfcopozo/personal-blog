...
export const BlogCard: React.FC<BlogPostProps> = ({ post, user }) => {
  const { title, content, createdAt, bookmarks, likes, comments } = post;
  return (
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            ...
            <div className="text-sm">
              ...
              <p className="text-muted-foreground">{showMonthDay(createdAt)}</p>
            </div>
          </div>
